...
//int32 bme280_readTemperature(void);
float bme280_readHumidity(void);
//int32 bme280_readHumidity(void);
//int32 bme280_readPressure(void);
...
//  bme280_setSampling(MODE_FORCED, SAMPLING_X4, SAMPLING_X4, SAMPLING_X4, FILTER_X8, STANDBY_MS_250); // for arduino
//  bme280_setSampling(MODE_NORMAL, SAMPLING_X2, SAMPLING_X16, SAMPLING_X1, FILTER_X16, STANDBY_MS_62_5); // for anonymass  
  bme_HW_WaitUs(100);
...
//  measRegmode = mode;
//  measRegosrs_t = tempSampling;
//  measRegosrs_p = pressSampling;

//  humRegosrs_h = humSampling;
//  configRegfilter = filter;
//  configRegt_sb = duration;
...
//  bme280_write8(BME280_REGISTER_CONTROLHUMID, 0x05);
...
//  bme280_write8(BME280_REGISTER_CONFIG, 0x00);
...
//  bme280_write8(BME280_REGISTER_CONTROL, 0xB7);
}
...
//    bme280_write8(BME280_REGISTER_CONTROL, MODE_FORCED);
...
float bme280_readTemperature(void) {
  ...
  var1 = ((((adc_T >> 3) - ((int32)bme280_dig_T1 << 1))) *
          ((int32)bme280_dig_T2)) >>
         11;

  var2 = (((((adc_T >> 4) - ((int32)bme280_dig_T1)) *
            ((adc_T >> 4) - ((int32)bme280_dig_T1))) >> 12) *
            ((int32)bme280_dig_T3)) >> 14;
...
float bme280_readHumidity(void) {
  ...
  v_x1_u32r = (((((adc_H << 14) - (((int32)bme280_dig_H4) << 20) -
                  (((int32)bme280_dig_H5) * v_x1_u32r)) +
                 ((int32)16384)) >>
                15) *
               (((((((v_x1_u32r * ((int32)bme280_dig_H6)) >> 10) *
                    (((v_x1_u32r * ((int32)bme280_dig_H3)) >> 11) +
                     ((int32)32768))) >>
                   10) +
                  ((int32)2097152)) *
                     ((int32)bme280_dig_H2) +
...
//  int32_t adc = read32();
  ...
  var2 = (((var1>>2) * (var1>>2)) >> 11 ) * ((int32)bme280_dig_P6);
  var2 = var2 + ((var1*((int32)bme280_dig_P5))<<1);
  var2 = (var2>>2) + (((int32)bme280_dig_P4)<<16);
  var1 = ((((int32)bme280_dig_P3 * (((var1>>2) * (var1>>2)) >> 13 )) >> 3) + ((((int32)bme280_dig_P2) * var1)>>1))>>18;
  var1 = ((((32768+var1))*((int32)((uint16)bme280_dig_P1)))>>15);
  if (var1 == 0) return 0;
...
//    p = (p / (uint32)var1) * 2;
//  }
  var1 = (((int32)bme280_dig_P9) * ((int32)(((p>>3) * (p>>3))>>13)))>>12;
  var2 = (((int32)(p>>2)) * ((int32)bme280_dig_P8))>>13;
  p = (uint32)((int32)p + ((var1 + var2 + bme280_dig_P7) >> 4));
  return p;
}
*/
float bme280_readPressure(void)
